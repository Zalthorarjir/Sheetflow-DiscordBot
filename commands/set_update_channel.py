...
def setup(bot):
    @bot.tree.command(name="set_update_channel", description="Set the channel for /update_request notifications")
    ...
    async def set_update_channel(interaction: discord.Interaction, channel: discord.TextChannel):
        ...
        set_guild_config(guild_id, update_channel_id=update_channel_id)
